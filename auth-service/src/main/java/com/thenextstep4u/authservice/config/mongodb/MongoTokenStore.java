package com.thenextstep4u.authservice.config.mongodb;

import com.thenextstep4u.authservice.domain.MongoAccessToken;
import com.thenextstep4u.authservice.domain.MongoRefreshToken;
