package com.thenextstep4u.emailmarketing.config;
...
@Configuration
@EnableScheduling
//@PropertySource("classpath:static/mail/emailconfig.properties")
public class SpringMailConfig {

    public static final String EMAIL_TEMPLATE_ENCODING = "UTF-8";

//    private static final String JAVA_MAIL_FILE = "classpath:static/mail/javamail.properties";
...
//    }
    ...
    public ResourceBundleMessageSource emailMessageSource() {
        ...
        messageSource.setBasename("static/mail/MailMessages");
...
//        templateResolver.setResolvablePatterns(Collections.singleton("html/*"));
        templateResolver.setPrefix("./mailRepository/");
